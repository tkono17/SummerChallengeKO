...
int ContinuousADC_ver2(int socket){
  ...
  t1 = time(NULL);
 int move_time;
 move_time = (int) 50/step_width;
 system( "python /home/smcha2019/SummerChallengeKO/code_for_stage/stage.py -o -  ");

 sleep(10);

 system( "python /home/smcha2019/SummerChallengeKO/code_for_stage/stage.py -mr 27219 "); 
...
for(int move_count=0;move_count<move_time;move_count++){
  ...
  while(EventNum < MaxCycleNum){
	...
	++abort;
      ...
      request<<"python /home/smcha2019/SummerChallengeKO/code_for_stage/stage.py -mr "<<step_width*500;
