...
Int_t fit32(Int_t i = 0)
{
  ...
  TH1F* ch =  ((TH1F*)gROOT->FindObject(Form("ch%d",i)));
//新しいヒストグラムchに、h25とかの名前のオブジェクトファイルを探してきてコピーする
  ...
  myText2(0.55,0.5,kBlack,Form("Mean2 - Mean1 = %5.2f", par[4]-par[1]),0.04);
