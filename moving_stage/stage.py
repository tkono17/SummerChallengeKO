...
parser.add_argument(
    "-ml", "--moveleft", help="move left by number of pulses", nargs=1, type=int
)
parser.add_argument(
    "-pr",
    "--positionright",
    help="move right to the cordinate of the pulse",
    nargs=1,
    type=int,
)
parser.add_argument(
    "-pl",
    "--positionleft",
    help="move left to the cordinate of the pulse",
    nargs=1,
    type=int,
)
